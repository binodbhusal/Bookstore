...
- Book Details: Users can view detailed information about each book, including the title, and author. This information helps users make informed decisions about their book selections.
- Add new book
...
```sh
 cd my-folder
 git clone https://github.com/binodbhusal/bookstore
```
### Install
